    ...
    <BlogPost
      ...
      content={
        <div className="space-y-6 text-foreground">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">The question nobody can answer in under a minute</h2>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">Why the cockpit can't help you here</h2>
          <p className="leading-relaxed">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">SAP IAS doesn't fill this gap either</h2>
          <p className="leading-relaxed">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">The everyday cost</h2>
          <p className="leading-relaxed">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">The way it should work</h2>
          <p className="leading-relaxed">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">Two minutes that change the conversation</h2>
          <p className="leading-relaxed">
            The fastest way to feel the difference is to try it. The BTP xID demo is on the product page — no install, no sign-up, just a feel for what landscape-wide user search looks like when it actually works.
          </p>
          <p className="leading-relaxed">
            <a href="/products/btp-xid" className="text-primary underline hover:no-underline">Open the BTP xID product page</a> and click <strong>Demo</strong> below the logon fields. Type a user, watch them appear across every Global Account, Sub-Account, CF Org and Space at once. Then ask yourself how long that report would have taken in the cockpit.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">Closing thought</h2>
          <p className="leading-relaxed">
