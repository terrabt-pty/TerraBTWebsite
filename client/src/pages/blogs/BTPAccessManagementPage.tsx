      ...
      <div style={{ background: "#FFFFFF", minHeight: "100vh" }}>
        ...
        <article style={{ maxWidth: "780px", margin: "0 auto", padding: "40px 24px 80px" }}>
          ...
          <p style={{ color: "#475569", fontSize: "1.125rem", lineHeight: 1.7, marginBottom: "48px", borderBottom: "1px solid #E2E8F0", paddingBottom: "32px" }}>
            SAP BTP has a layered access model that confuses even experienced admins. IAS handles authentication. IPS handles provisioning. The BTP cockpit handles role collections. CF UAA handles org and space memberships. None of these systems talk to each other. There is no single consistent view of who has access to what, and no way to act on that view at scale.
          </p>
          ...
          <section style={{ marginBottom: "48px" }}>
            ...
            <p style={{ color: "#475569", lineHeight: 1.7 }}>
              This makes offboarding particularly risky. When a user leaves, an administrator must manually revoke role collections from every subaccount, remove CF org memberships from every org, remove CF space memberships from every space, and remove the user from IAS. In a landscape with thirty subaccounts across five Global Accounts, this is not a five-minute task. It is error-prone enough that many organisations leave dormant access in place.
            </p>
          </section>
          ...
          <section style={{ marginBottom: "48px", background: "#F8FAFC", borderRadius: "12px", padding: "32px", border: "1px solid #E2E8F0" }}>
            ...
            <p style={{ color: "#475569", lineHeight: 1.7, marginBottom: "16px" }}>
              Many BTP customers run entirely on SAP ID Service, the default SAP identity provider, with no IAS deployment at all. This is common among older installations, smaller IT teams, and BTP environments set up before IAS became the standard recommendation. Some will never adopt IAS, whether due to budget constraints, organisational complexity, or simply because the existing setup works for their needs.
            </p>
            <p style={{ color: "#475569", lineHeight: 1.7, marginBottom: "16px" }}>
              For these customers, BTP xID functions as a standalone access governance layer. There is no IAS prerequisite. BTP xID connects directly to the BTP APIs and the Cloud Foundry API, the same APIs the cockpit uses. It provides a unified management interface regardless of which identity provider authenticates your users.
            </p>
            <p style={{ color: "#475569", lineHeight: 1.7 }}>
              If you are in this situation, BTP xID effectively replaces the need to set up and maintain IPS target configurations for access management. You get landscape-wide visibility, bulk operations, and CF org/space management through a single interface. No IPS system to configure, no group naming convention to maintain.
            </p>
          </section>
          ...
          <section style={{ marginBottom: "48px" }}>
            ...
            <p style={{ color: "#475569", lineHeight: 1.7, marginBottom: "16px" }}>
              BTP xID connects to BTP's platform APIs and the Cloud Foundry API to give administrators a single interface that spans all four levels of the BTP access model: Global Account, Directory, Subaccount, and Cloud Foundry org and space. It surfaces every API credential across all of them.
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
              {[
                ...
                { title: "Landscape-Wide Visibility", body: "See every role a user holds across all subaccounts, Global Accounts, directories, CF orgs, and CF spaces in one view. Reverse lookup works too: start from any resource and see who has access." },
                ...
                { title: "Complete Offboarding", body: "Remove all BTP access in one action: role collections and CF memberships, across every account and org. Reduces the risk of dormant access after a user departure." },
