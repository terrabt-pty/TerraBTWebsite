...
import { ArrowLeft, ArrowRight, CheckCircle, Lightbulb, Users, Target, Rocket, TestTube, RefreshCw, BookOpen } from "lucide-react";
          ...
          <Card className="p-8 border-primary/20 bg-gradient-to-r from-primary/5 to-trust/5">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1">
                ...
                <h3 className="text-2xl font-bold mb-2 text-foreground">{t('blog.post11.title')}</h3>
                <p className="text-muted-foreground mb-4 md:mb-0 max-w-2xl">{t('blog.post11.excerpt')}</p>
              </div>
              <Link href={getLocalizedPath("/blog/user-centered-innovation-with-design-thinking")}>
